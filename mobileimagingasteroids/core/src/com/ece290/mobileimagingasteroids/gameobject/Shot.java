...
public class Shot extends GameObject{
    public Shot(int width, int height, float positionX, float positionY, float velocityX, float velocityY, float period){
        super(width, height, positionX, positionY, velocityX, velocityY, period);
    }
